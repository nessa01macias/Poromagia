...
dirname = "C:\\Users\\nessa\\Poromagia\\Poromagia\\cv-documentation\\cv-tests"
...
@pytest.fixture()
def get_text2():
    file_path = dirname + 'img\\2.jpg'
    return TextParser(file_path)


@pytest.fixture()
def get_text3():
    file_path = dirname + 'img\\3.jpg'
    return TextParser(file_path)


@pytest.fixture()
def get_text4():
    file_path = dirname + 'img\\4.jpg'
    return TextParser(file_path)


@pytest.fixture()
def get_text5():
    file_path = dirname + 'img\\5.jpg'
    return TextParser(file_path)
...
@pytest.fixture()
def get_text6():
    file_path = dirname + 'img\\6.jpg'
    return TextParser(file_path)


@pytest.fixture()
def get_text7():
    file_path = dirname + 'img\\7.jpg'
    return TextParser(file_path)


@pytest.fixture()
def get_text8():
    file_path = dirname + 'img\\8.jpg'
    return TextParser(file_path)


@pytest.fixture()
def get_text9():
    file_path = dirname + 'img\\9.jpg'
    return TextParser(file_path)


@pytest.fixture()
def get_text10():
    file_path = dirname + 'img\\10.jpg'
    return TextParser(file_path)


@pytest.fixture()
def get_text11():
    file_path = dirname + 'img\\11.jpg'
    return TextParser(file_path)


@pytest.fixture()
def get_text12():
    file_path = dirname + 'img\\12.jpg'
    return TextParser(file_path)


@pytest.fixture()
def get_text13():
    file_path = dirname + 'img\\13.jpg'
    return TextParser(file_path)


@pytest.fixture()
def get_text14():
    file_path = dirname + 'img\\14.jpg'
    return TextParser(file_path)


@pytest.fixture()
def get_text15():
    file_path = dirname + 'img\\15.jpg'
    return TextParser(file_path)
